...
Public Class BasisData
    ...
    Private idMapel As Integer = 2
    Private panduanSudahMuncul As Boolean = False
    Private waktuMulai As DateTime

    ' === Saat Form Dibuka ===
    Private Sub BasisData_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Not panduanSudahMuncul Then
            MessageBox.Show(
                "📘 PANDUAN QUIZ BASIS DATA 📘" & vbCrLf & vbCrLf &
                "1️⃣ Bacalah setiap soal dengan teliti." & vbCrLf &
                "2️⃣ Setiap soal memiliki waktu terbatas (30 detik per soal)." & vbCrLf &
                "3️⃣ Skor akhir akan muncul di akhir kuis." & vbCrLf &
    ...
    Private Sub muatSoal()
        Try
            soalList.Clear()
            Dim query As String = "SELECT * FROM tbl_soal_basisdata ORDER BY id_soal"
        ...
        Catch ex As Exception
            MessageBox.Show("Gagal memuat soal Basis Data: " & ex.Message)
        End Try
    End Sub
    ...
    ' === Akhir kuis (baik selesai maupun waktu habis) ===
